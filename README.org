...
/Note: The =priority= predicate's support for comparator symbols is currently limited to the sexp syntax./
...
*Added*
+  Alternative, non-sexp-based query syntax for commands =org-ql-search= and =helm-org-ql=.
+  Command =helm-org-ql=.
